...
class ForgotPasswordPageTextFieldInputs extends StatelessWidget {
  const ForgotPasswordPageTextFieldInputs({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return FormBuilder(
      ...
      child: Column(
        children: <Widget>[
          Text(
            LocalizationsStrings.auth.forgotPassword.title.tr(),
